      ...
      <div class="row my-0 mb-4">
        <div class="col-12">
          <div class="alert alert-danger mt-4 mb-0" role="alert">
            <h4>
              Уважаемые коллеги! Приём заявлений по графику сентября будет
              проходить с 01 по 09 сентября, так как с 01 сентября вступает в
              силу новый Порядок Приказ Минпросвещения РФ от 24.03.2023 N 196
              «Об утверждении порядка проведения аттестации педагогических
              работников организаций, осуществляющих образовательную
              деятельность».
            </h4>
            <div>
              В соответствии с П28 нового порядка в заявлении в аттестационную
              комиссию педагогические работники сообщают:
            </div>
            <ul>
              <li>сведения об уровне образования (квалификации)</li>
              <li>
                о результатах профессиональной деятельности в организациях
              </li>
              <li>об имеющихся квалификационных категориях</li>
              <li>
                а также указывают должность, по которой они желают пройти
                аттестацию
              </li>
            </ul>
          </div>

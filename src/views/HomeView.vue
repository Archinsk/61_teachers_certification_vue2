        ...
        <div class="col-12">
          <div class="alert alert-danger mt-4 mb-0" role="alert">
            <h4>
              ...
              «Народное признание» XI Всероссийского конкурса «ПРОФ-IT», в
              которой представлен проект ГИС Аттестация педагогических
              работников. Просим Вас поддержать проект, проголосовав за него по
              ссылке
              <a
                href="https://prof-it.d-russia.ru/narodnoe-priznanie/attestatsiya-pedagogicheskih-rabotnikov"
                target="_blank"
                >https://prof-it.d-russia.ru/narodnoe-priznanie/attestatsiya-pedagogicheskih-rabotnikov</a
              >
              . Каждый день мы работаем над улучшением системы и всегда
